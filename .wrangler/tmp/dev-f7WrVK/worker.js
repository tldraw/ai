...
// .wrangler/tmp/bundle-xAAbN8/checked-fetch.js
        ...
        properties: {
          ...
          binding: {
            ...
            properties: {
              ...
              type: {
                type: SchemaType.STRING,
                description: "The type of the binding. Refer to the `default binding props` in the prompt for a list of which bindings are valid.",
                enum: ["arrow"]
              },
              props: {
                type: SchemaType.STRING,
                description: "The properties of the binding as stringified JSON. We will use JSON.parse to parse it. Refer to the `default binding props` in the prompt for an idea about what props are valid and what their defaults are. You only need to provide props that are different from the defaults; the defaults will be used for all props not provided here."
              }
            },
            required: ["id", "type"]
          },
          shape: {
            ...
            properties: {
              ...
              type: {
                type: SchemaType.STRING,
                description: "The type of the shape. Refer to the `default shape props` in the prompt for a list of which shapes are valid.",
              ...
              props: {
                type: SchemaType.STRING,
                description: "The properties of the shape as stringified JSON. We will use JSON.parse to parse it. Refer to the `default shape props` in the prompt for an idea about what props are valid and what their defaults are. You only need to provide props that are different from the defaults; the defaults will be used for all props not provided here."
              }
            },
            required: ["id", "type"]
          }
...
// .wrangler/tmp/bundle-xAAbN8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xAAbN8/middleware-loader.entry.ts
